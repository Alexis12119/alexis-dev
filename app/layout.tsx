...
export const metadata: Metadata = {
  ...
  keywords: ["Full-Stack Developer", "React", "Next.js", "TypeScript", "Neovim", "Open Source"],
  ...
  openGraph: {
    ...
    description: "Full-Stack Developer & Neovim Enthusiast building fast, maintainable solutions across the stack.",
